                    ...
                    @foreach ($orders as $order)
                        <li class="list-group-item">
                            ...
                            <div class="media align-items-lg-center flex-column flex-lg-row">
                                <img src="{{ asset('uploads/pump/' . $order->pump_image) }}" alt="Generic placeholder image"
                                    width="250" height="200" class="order-1 order-lg-1">
                                ...
                                <div class="media-body order-2 order-lg-2 ml-lg-5">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-1">
                                        ...
                                        <ul class="list-inline small">
                                            ...
                                            @if (!empty($order->diesel_qty))
                                                ...
                                                @endif @if (!empty($order->premium_petrol_qty))
                                                    <li><img
                                                            src="https://img.icons8.com/material-outlined/10/000000/filled-circle--v1.png">Premium
                                                        Petrol:
                                        ...
                                        <ul class="list-inline small">
                                            ...
                                            <li> <a href="{{route('acceptOrder',$order->id)}}"class="btn btn-success">Accept Order </a>
                                            </li>
